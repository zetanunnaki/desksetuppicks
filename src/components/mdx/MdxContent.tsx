...
export async function MdxContent({ source }: MdxContentProps) {
  return (
    <div className="prose prose-lg prose-invert max-w-none prose-headings:font-sans prose-headings:font-extrabold prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-16 prose-h2:border-l-4 prose-h2:border-indigo-500 prose-h2:pl-6 prose-h3:text-xl prose-p:text-slate-400 prose-p:leading-[1.8] prose-a:text-indigo-400 prose-a:no-underline hover:prose-a:text-indigo-300 prose-strong:text-slate-200 prose-li:text-slate-400 prose-li:leading-relaxed prose-hr:border-slate-800 [&>p:first-of-type]:text-xl [&>p:first-of-type]:leading-relaxed [&>p:first-of-type]:text-slate-300">
