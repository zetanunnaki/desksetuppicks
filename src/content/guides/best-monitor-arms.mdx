...
For the median user with a single monitor up to 32 inches and 20 lbs, buy the [HUANUO FlowLift Single Monitor Mount](/reviews/monitor-arms/). It is a true gas-spring mount with full motion, both mounting options in the box, and no sag over months of use, all at about 35.99, which is the best balance of price and performance here.
